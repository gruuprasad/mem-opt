...
Function * BatchMaker::createBatchFunction() {
  FunctionType *BatchFuncType = FunctionType::get(OldFunc->getReturnType(), NewParams, false);
...
void BatchMaker::setArgumentNames() {
  // Set argument names.
...
void BatchMaker::createBatchedFormFn() {
  ...
  ReturnInst::Create(NewFunc->getContext(), Constant::getNullValue(OldFunc->getReturnType()), EndBlock);
