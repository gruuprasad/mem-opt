; ModuleID = 'cache_test3.c'
source_filename = "cache_test3.c"
...
define dso_local void @test_fn(%struct.packet_state*, %struct.packet_state*) #0 {
  ...
  %8 = getelementptr inbounds %struct.packet_state, %struct.packet_state* %7, i32 0, i32 10
  store i64 8000, i64* %8, align 8
  %9 = load %struct.packet_state*, %struct.packet_state** %4, align 8
  %10 = getelementptr inbounds %struct.packet_state, %struct.packet_state* %9, i32 0, i32 7
