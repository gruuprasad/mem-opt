...
for.cond10:                                       ; preds = %for.inc17, %for.end
  ...
  br i1 %exitcond, label %for.body13, label %for.cond.cleanup12

for.cond.cleanup12:                               ; preds = %for.cond10
  br label %for.end19

for.body13:                                       ; preds = %for.cond10
  %arrayidx15 = getelementptr inbounds i32*, i32** %b, i64 %indvars.iv
...
; Function Attrs: nounwind uwtable
define dso_local i32 @singlularFn(i32 %c, i32* %b, i32* %a) #3 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %6) #4
  %7 = bitcast [2 x i32*]* %a_list to i8*
  call void @llvm.lifetime.end.p0i8(i64 16, i8* %7) #4
...
; Function Attrs: nounwind uwtable
define dso_local i32 @batch_fn(i32 %c, i32** %batch_arg_1, i32** %batch_arg_2, i32 %TAS_BATCHSIZE) #3 {
entry:
  %0 = alloca i32**
  store i32** %batch_arg_1, i32*** %0
  %b.addr = alloca i32*, align 8
  %a.addr = alloca i32*, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i32 %add, i32* %19, align 4, !tbaa !6
  %add3 = add nsw i32 %c, 10
  br label %if.end
...
attributes #3 = { nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "tas_batch_maker" "unsafe-fp-math"="false" "use-soft-float"="false" }
